...
import models.Item;
import models.PickupItem;
import models.PostedItem;
...
public class PostItemServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Process request from web client's inputs(uname, upwd)
        String itemType, itemSize, modelNumber; 
        
        itemType = request.getParameter("itemType");
        itemSize = request.getParameter("itemSize");
        modelNumber = request.getParameter("modelNumber");
        
        Item item = new Item(itemType, itemSize, modelNumber);
        
        PickupItem pickupItem = new PickupItem(item);
        
        pickupItem.postItem();
       
        response.sendRedirect("accountAccess.html");
